  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M30.831 19.83l4.462 9.497a.269.269 0 01-.055.296L23.5 40.963c-.088.077-.22.022-.22-.098v-10.42l7.396-7.139c.055-.044.077-.12.077-.186l.022-3.29c0-.022.044-.022.055 0z"
        fill="#6000FF"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M35.315 29.492a.287.287 0 00-.022-.165L30.83 19.83c-.011-.022-.055-.022-.055.01l-.022 3.29a.21.21 0 01-.044.132l4.605 6.23z"
        fill="url(#prefix__prefix__paint0_linear_11640_1543)"
      />
      <path
        opacity={0.2}
        fillRule="evenodd"
        clipRule="evenodd"
        d="M35.315 29.492c.01-.055 0-.11-.022-.165l-.231-.493-4.066-5.21 4.319 5.868z"
        fill="#fff"
      />
      <g opacity={0.5}>
        <mask
        ...
        <g mask="url(#prefix__a)">
          <path
            fill="url(#prefix__prefix__pattern0)"
            d="M16.742 19.72h15.935v25.225H16.742z"
          />
        </g>
      </g>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M20.281 11.856L18.182 17.8a.274.274 0 00.011.209l1.956 3.85-5.385 3.048c-.066.033-.154.011-.187-.055l-1.165-2.423a.233.233 0 01.022-.253l6.792-10.353c.022-.022.066 0 .055.033z"
        fill="#6000FF"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M18.16 17.877c0-.022 0-.044.011-.066l2.1-5.955c.01-.033-.034-.044-.045-.022L13.71 21.76l3.121-2.665-3.428 3.147 4.758-4.365z"
        fill="url(#prefix__prefix__paint1_linear_11640_1543)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M13.71 21.749l-.275.417-.033.065 3.428-3.147-3.12 2.665z"
        fill="url(#prefix__prefix__paint2_linear_11640_1543)"
      />
      <path
        opacity={0.2}
        fillRule="evenodd"
      ...
      <g opacity={0.4}>
        ...
        <g opacity={0.4}>
          ...
          <g mask="url(#prefix__b)">
            <path
              fill="url(#prefix__prefix__pattern1)"
              d="M8.061 17.197h19.561v14.696H8.061z"
            />
          </g>
        </g>
      </g>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M23.38 7.03l4.956 12.13a.304.304 0 010 .198l-8 18.721a.126.126 0 01-.209.044l-7.363-7.107a.254.254 0 01-.033-.34l10.495-14.224a.262.262 0 00.055-.154V7.053c0-.055.077-.077.1-.022z"
        fill="url(#prefix__prefix__paint3_linear_11640_1543)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M24.226 16.923l-.78-.438 4.824 2.522-4.89-11.976c-.022-.055-.099-.033-.099.022v9.245c0 .022 0 .055-.011.077l.956.548z"
        fill="url(#prefix__prefix__paint4_linear_11640_1543)"
      />
      <path
        opacity={0.2}
        fillRule="evenodd"
        clipRule="evenodd"
        d="M28.347 19.26c0-.012 0-.012 0 0l-4.132-2.337 4.132 2.336z"
        fill="#fff"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M24.226 16.923l4.121 2.336c0-.033-.01-.055-.022-.088l-.066-.164-4.824-2.523.791.44z"
        fill="url(#prefix__prefix__paint5_linear_11640_1543)"
      />
      <path
        opacity={0.2}
        fillRule="evenodd"
      ...
      <defs>
        <linearGradient
          id="prefix__prefix__paint0_linear_11640_1543"
          x1={30.994}
          y1={18.969}
          x2={35.678}
          y2={22.833}
        ...
        <linearGradient
          id="prefix__prefix__paint1_linear_11640_1543"
          x1={20.131}
          y1={13.45}
          x2={11.658}
          y2={18.984}
        ...
        <linearGradient
          id="prefix__prefix__paint2_linear_11640_1543"
          x1={19.98}
          y1={13.35}
          x2={14.609}
          y2={22.925}
        ...
        <linearGradient
          id="prefix__prefix__paint3_linear_11640_1543"
          x1={1.331}
          y1={52.52}
          x2={29.391}
          y2={42.134}
        ...
        <linearGradient
          id="prefix__prefix__paint4_linear_11640_1543"
          x1={23.142}
          y1={11.487}
          x2={30.458}
          y2={12.997}
        ...
        <linearGradient
          id="prefix__prefix__paint5_linear_11640_1543"
          x1={21.652}
          y1={12.733}
          x2={23.885}
          y2={21.065}
        ...
        >
          <use
            xlinkHref="#prefix__prefix__image0_11640_1543"
            transform="scale(.0069 .00435)"
          />
        </pattern>
        <pattern
          id="prefix__prefix__pattern1"
          patternContentUnits="objectBoundingBox"
          width={1}
          height={1}
        >
          <use
            xlinkHref="#prefix__prefix__image1_11640_1543"
            transform="scale(.00562 .00746)"
          />
        </pattern>
        <image
          id="prefix__prefix__image0_11640_1543"
          width={145}
          height={230}
        ...
        />
        <image
          id="prefix__prefix__image1_11640_1543"
          width={178}
          height={134}
  ...
  function BlochainwalletInversion(
    ...
    return (
      ...
      >
        ...
        />
        <path
          d="M11.44 20.02l-1.383 1.382a3.911 3.911 0 00-1.215 2.844 3.909 3.909 0 001.215 2.834l11.139 11.257c.266.267.572.494.908.662V25.362L11.44 20.019z"
          fill="#3D89F5"
        />
        <path
          d="M36.56 20.02l1.383 1.382a3.912 3.912 0 010 5.668L26.805 38.328a3.515 3.515 0 01-.909.661V25.362l10.665-5.343z"
          fill="#1656B9"
        />
        <path
          d="M33.885 17.195l-6.972-6.991a3.828 3.828 0 00-1.303-.89 3.909 3.909 0 00-3.081 0 4.189 4.189 0 00-1.304.89l-6.981 6.991 9.796 4.888 9.845-4.888z"
          fill="#85B5F8"
        />
      </svg>
    );
...
export const Brave = React.forwardRef(function Brave(
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M31.567 11.174L28.822 8h-9.644l-2.745 3.174s-2.41-.683-3.55.477c0 0 3.215-.296 4.32 1.535 0 0 2.98.58 3.382.58.402 0 1.272-.341 2.076-.614.803-.273 1.34-.275 1.34-.275s.535.002 1.338.275c.804.273 1.675.614 2.076.614.402 0 3.382-.58 3.382-.58 1.105-1.83 4.32-1.535 4.32-1.535-1.14-1.16-3.55-.477-3.55-.477z"
          fill="#fff"
        />
      </mask>
      <g mask="url(#prefix__a)">
        <path
          d="M31.567 11.174L28.822 8h-9.644l-2.745 3.174s-2.41-.683-3.55.477c0 0 3.215-.296 4.32 1.535 0 0 2.98.58 3.382.58.402 0 1.272-.341 2.076-.614.803-.273 1.34-.275 1.34-.275s.535.002 1.338.275c.804.273 1.675.614 2.076.614.402 0 3.382-.58 3.382-.58 1.105-1.83 4.32-1.535 4.32-1.535-1.14-1.16-3.55-.477-3.55-.477z"
          fill="url(#prefix__prefix__paint1_linear_11995_1639)"
        />
      </g>
      <defs>
        <linearGradient
          id="prefix__prefix__paint0_linear_11995_1639"
          x1={10.607}
          y1={24.226}
          x2={37.393}
          y2={24.226}
        ...
        <linearGradient
          id="prefix__prefix__paint1_linear_11995_1639"
          x1={13.361}
          y1={10.924}
          x2={35.116}
          y2={10.924}
